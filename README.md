...
Scramjet-4 will be released in coming weeks. The programming interface will change in order to aim simlicity in using
async/await as much as possible.

Backwards compatibility with promises will not be actively kept.
...
stream from whatever source and call any number of API's consecutively. It fully supports ES2015 async operations in
