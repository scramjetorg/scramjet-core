...
module.exports = {
   ...
   */
  createTransformModule(transform, {
    StreamClass = module.exports.DataStream
  } = {}, ...initialArgs) {
    return function (stream, ...extraArgs) {
      return StreamClass.from(stream).use(transform, ...initialArgs, ...extraArgs);
    };
  },
  ...
  plugin(mixins) {
    ...
    for (var _i = 0; _i < _arr.length; _i++) {
      ...
      if (key in this) {
        ...
        Object.getOwnPropertyNames(Mixin).forEach(prop => Object.defineProperty(Stream.prototype, prop, Object.getOwnPropertyDescriptor(Mixin, prop)));
      } else {
        this[key] = mixins[key];
      }
    }
