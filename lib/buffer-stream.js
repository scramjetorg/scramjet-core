...
class BufferStream extends scramjet.DataStream {
     ...
     * @example "samples/buffer-stream-constructor.js"
     */
    constructor(...args) {
        super(...args);
        this.buffer = [];
     ...
     *
     * @example "samples/string-stream-shift.js"
     */
    shift(bytes, func) {
     ...
     * @example "samples/buffer-stream-split.js"
     */
    split(splitter) {
     ...
     * @example "samples/buffer-stream-breakup.js"
     */
    breakup(number) {
     ...
     * @example "samples/buffer-stream-tostringstream.js"
     */
    stringify(encoding) {
     ...
     * @example "samples/buffer-stream-parse.js"
     */
    parse(parser) {
