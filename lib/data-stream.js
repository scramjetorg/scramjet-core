...
class DataStream extends PromiseTransformStream {
     ...
     * @return {self} new instance of a scramjet stream
     */
    static from(stream, options) {
        return stream.pipe(
            new this(Object.assign({}, options, { referrer: stream instanceof DataStream ? stream : null }))
        );
    }
