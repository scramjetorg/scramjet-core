...
const getCalleDirname = function(depth) {
...
class DataStream extends PromiseTransformStream {
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-constructor.js"
     */
    constructor(opts) {
        super(Object.assign({
            objectMode: true,
     ...
     *
     * @example "samples/data-stream-map.js"
     */
    map(func, Clazz) {
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-filter.js"
     */
    filter(func) {
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-reduce.js"
     */
    reduce(func, into) {
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-into.js"
     */
    into(func, into) {
        if (!(into instanceof DataStream)) throw new Error("Stream must be passed!");

        this.catch(e => into.raise(e))
            .tap()
            .pipe(new PromiseTransformStream({
                parallelTransform: (chunk) => func(into, chunk),
                referrer: this
            }))
            .resume();
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-use.js"
     */
    use(func, ...args) {
        switch (typeof func) {
            case "function":
            ...
            case "string":
                return require(func.startsWith('.') ? path.resolve(getCalleDirname(1), func) : func)(this, ...args);
            default:
                throw new Error("Must provide function or resolvable module path");
        }
    }
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-tee.js"
     */
    tee(func) {
     ...
     *
     * @example "samples/data-stream-tobufferstream.js"
     */
     ...
     *
     * @example "samples/data-stream-tostringstream.js"
     */
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-fromarray.js"
     */
     ...
     *
     * @includedoc readme
     * @example "samples/data-stream-fromiterator.js"
     */
     ...
     * @name tap
     * @method
     * @example "samples/data-stream-tap.js"
     */
     ...
     * @example "samples/data-stream-selfinstance.js"
     */
    _selfInstance(...args) {
