...
class DataStream extends PromiseTransformStream {
     ...
     *
     * @chainable
     * @param {Array|Iterable|AsyncGeneratorFunction|GeneratorFunction|AsyncFunction|Function|String|Readable} func if passed, the function will be called on self to add an option to inspect the stream in place, while not breaking the transform chain. Alternatively this can be a relative path to a scramjet-module. Lastly it can be a Transform stream.
    ...
    use(func, ...args) {
        if (typeof func === "function") {
            ...
            return this.pipe(this.constructor.from(func, {}, ...args));
        }
