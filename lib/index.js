...
module.exports = {
    ...
    /**
     * Creates a safe wrapper for scramjet transform module. See [Modules documentation]({@link modules.md}) for more info.
     *
     * @param {UseCallback} transform
     * @param {CreateModuleOptions} options
     * @param  {...any} initialArgs
     */
    createTransformModule(transform, {StreamClass = this.DataStream} = {}, ...initialArgs) {
        return function (stream, ...extraArgs) {
            StreamClass.from(stream)
                .use(transform, ...initialArgs, ...extraArgs);
        };
    },

    /**
     * Creates a safe wrapper for scramjet read module. See [Modules documentation]({@link modules.md}) for more info.
     *
     * @param {Array|Iterable|AsyncGeneratorFunction|GeneratorFunction|AsyncFunction|Function|String|Readable} anything
     * @param {CreateModuleOptions} options
     * @param  {...any} initialArgs
     */
    createReadModule(anything, {StreamClass = this.DataStream} = {}, ...initialArgs) {
        return (...extraArgs) => {
