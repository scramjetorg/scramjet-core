...
/** @ignore */
const PromiseTransformStream = require("./util/promise-transform-stream").PromiseTransformStream;
/** @ignore */
 ...
 */
class MultiStream extends PromiseTransformStream {
    ...
    /**
     *
     * @param {Array|Iterator|AsyncIterator|Function|AsyncFunction|Generator|AsyncGenerator} iterable any iterable of streamables including stream of streams!
     * @returns {MultiStream}
     */
    static from(input, options, ...args) {
        ...
        if (typeof func == "string") {
            input = require(input.startsWith(".") ? resolveCalleeBlackboxed(input) : input);
        }
