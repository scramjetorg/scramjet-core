...
class MultiStream extends EventEmitter {
     ...
     *
     * @param  {stream.Readable[]|AsyncGenerator<Readable>|Generator<Readable>} streams the list of readable streams (other
     ...
     *
     * @param {Array<Array|Iterable|AsyncGeneratorFunction|GeneratorFunction|AsyncFunction|Function|String|Readable>} streams the array of input streamlike elements
     * @param {Function extends DataStream} [StreamClass=DataStream]
     * @returns {MultiStream}
     */
     ...
     * @param {class} [ClassType=DataStream] the class to be outputted
