...
class MultiStream extends EventEmitter {
     ...
     *
     * @example "samples/multi-stream-constructor.js"
     */
     ...
     *
     * @example "samples/multi-stream-map.js"
     */
    map(aFunc, rFunc) {
        return Promise.all(
            this.streams.map(
     ...
     *
     * @example "samples/multi-stream-filter.js"
     */
    filter(func) {
        return Promise.all(
            this.streams.map(
     ...
     *
     * @example "samples/multi-stream-mux.js"
     */
    mux(cmp, Clazz) {
     ...
     *
     * @example "samples/multi-stream-add.js"
     */
    add(stream) {
     ...
     * @param {stream.Readable} stream [description]
     *
     * @example "samples/multi-stream-remove.js"
     */
    remove(stream) {
