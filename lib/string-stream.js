...
class StringStream extends scramjet.DataStream {
     ...
     *
     * @example "samples/string-stream-constructor.js"
     */
     ...
     *
     * @example "samples/string-stream-split.js"
     */
    split(splitter) {
     ...
     *
     * @example "samples/string-stream-match.js"
     */
    match(matcher) {
     ...
     *
     * @example "samples/string-stream-tobufferstream.js"
     */
    toBufferStream() {
        return this.tap().map(
     ...
     */
      ...
      *
      * @example "samples/string-stream-parse.js"
      */
