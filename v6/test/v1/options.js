...
const _require = require(process.env.SCRAMJET_TEST_HOME || "../../"),
      ScramjetOptions = _require.ScramjetOptions;

class A {
  constructor(ref) {
    this._options = new ScramjetOptions(this, ref, {
      option0: -1
    });
  }
...
ScramjetOptions.declare(A, "option0", {
  chained: true
});
module.exports = {
  test_declare: {
    single(test) {
      ...
      test.doesNotThrow(() => {
        ...
        ScramjetOptions.declare(A, "option2", {
          value: 1
        });
      });
      test.done();
    ...
    chained(test) {
      test.doesNotThrow(() => {
        ScramjetOptions.declare(A, "option3", {
          chained: true
        });
        ScramjetOptions.declare(A, "option4", {
          chained: true,
          value: 2
        });
        ScramjetOptions.declare(A, "option5", {
          chained: true,
          value: 3
        });
        ScramjetOptions.declare(B, "option5", {
          chained: true,
          value: 4
        });
        ScramjetOptions.declare(B, "option6", {
          chained: true
        });
        ScramjetOptions.declare(B, "option7", {
          chained: true,
          value: 5
        });
        ScramjetOptions.declare(B, "option8", {
          chained: false,
          value: 6
        });
      });
