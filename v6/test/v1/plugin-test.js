...
let addX = function addX(test) {
  test.equals(this[xSymbol], xSymbol, "this must point to the stream context");
  return this;
};

const _require$plugin = require(process.env.SCRAMJET_TEST_HOME || "../../").plugin({
  staticValue: xSymbol,
  DataStream: {
    constructor() {
      cnt++;
  ...
  StringStream: {
    constructor({
      ...
      DataStream = _require$plugin.DataStream,
      StringStream = _require$plugin.StringStream,
      staticValue = _require$plugin.staticValue;
